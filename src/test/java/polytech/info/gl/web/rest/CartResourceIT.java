...
import polytech.info.gl.service.mapper.CartMapper;
...
class CartResourceIT {
    ...
    void getAllCarts() throws Exception {
        ...
        restCartMockMvc
            ...
            .andExpect(jsonPath("$.[*].deadline").value(hasItem(DEFAULT_DEADLINE.doubleValue())));
    }
    ...
    void getCart() throws Exception {
        ...
        restCartMockMvc
            ...
            .andExpect(jsonPath("$.deadline").value(DEFAULT_DEADLINE.doubleValue()));
    }
