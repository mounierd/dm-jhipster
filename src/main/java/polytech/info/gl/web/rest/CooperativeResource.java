...
public class CooperativeResource {
    ...
    public ResponseEntity<CooperativeDTO> updateCooperative(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, cooperativeDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<CooperativeDTO> partialUpdateCooperative(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, cooperativeDTO.getId())
        );
    }
    ...
    public ResponseEntity<CooperativeDTO> getCooperative(@PathVariable String id) {
